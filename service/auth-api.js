...
export const authAPI = {
  loginWithGoogle: async () => {
    window.location.href = "https://cnbe.onrender.com/api/v1/auth/google"
  },
  loginWitGithub: async () => {
    window.location.href = "https://cnbe.onrender.com/api/v1/auth/github"
  },
  loginWithProvider: async (provider) => {
    const baseUrl = "https://cnbe.onrender.com/api/v1/auth";
